...
export async function startGatewayServer(
  ...
  // Also inject into process.env so the new undici EnvHttpProxyAgent picks it up.
  ...
  if (proxyUrl) {
    ...
    // Inject into env so undici EnvHttpProxyAgent and provider-request-config env-proxy mode work.
